...
public class SqlLib {
    ...
    public boolean registrarClienteNuevo(String nombre, String correo, String password) {
        String sql =
            "INSERT INTO usuarios (nombre, correo, password, rol_id, puede_login) " +
            "VALUES (?, ?, ?, 6, TRUE)";
    ...
    public ObservableList<Reservacion> getReservacionesPorUsuario(String correo) {
        ...
        String query =
            "SELECT r.id_reservacion, r.fecha_reserva, r.hora_reserva, r.id_mesa, r.num_personas, " +
            "r.estatus, r.modificada, u.nombre, " +
            "CASE " +
    ...
    public boolean registrarNuevaReservacion(String correoUsuario, String fecha, String hora, int idMesa, int personas) {
        ...
        String sqlInsert =
            "INSERT INTO reservaciones (id_usuario, fecha_reserva, hora_reserva, id_mesa, num_personas, estatus) " +
            "VALUES (?, ?, ?, ?, ?, 'Confirmada')";
    ...
    public boolean modificarReservacion(
    ...
    public List<Map<String, Object>> obtenerListaEsperaVigente() {
        ...
        String sql =
            "SELECT id_espera, nombre_cliente, num_personas " +
            "FROM lista_espera " +
    ...
    public boolean atenderClienteListaEspera(int idEspera, int idMesa) {
        String sqlEspera =
            "UPDATE lista_espera SET estatus = 'Atendido', id_mesa_asignada = ? WHERE id_espera = ?";
    ...
    public void registrarHistorial(String correo) {
        System.out.println("Inicio de sesión registrado para: " + correo);
    }
}